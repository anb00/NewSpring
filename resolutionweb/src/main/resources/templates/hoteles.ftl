...
<html lang="es" dir="ltr" data-light-ogb="true" xmlns="http://www.w3.org/1999/html">
   <head>
      ...
      <link href="css/csslibrary.css" rel="stylesheet" type="text/css">
      ...
      <style>
         @font-face {
            ...
            src: url('fonts/ToetheLineless.ttf');
            src: local('☺'), url('fonts/ToetheLineless.ttf') format('truetype');
            font-weight: normal;
            font-style: normal;
         }
         #logo {
      ...
      <link rel="icon" href="/img/favicon-magic.ico" type="image/x-icon" />
   </head>
      ...
      <div role="main" class="application-main " style="background-color: red;">
         ...
         <div id="js-pjax-container" data-pjax-container="" style="background-color: green;">
            <div class="container-lg clearfix px-3 mt-4" style="background-color:yellow;">
               <div class="h-card col-3 float-left pr-3" style="background-color:black;">
                  ...
                  <div class="vcard-names-container py-3 js-sticky js-user-profile-sticky-fields" style="position: static;">
                     ...
                     <div class="h-card col-3 float-left pr-3" style="background-color:white;">
                        ...
                        <select   class="btn select-menu-button js-menu-target" type="button" >
                           <option value='' disabled selected class="js-select-button">Select category</option>
                           <option value='1' class="js-select-button">··Hoteles </option>
                           <option value='2' class="js-select-button">··Restaurants </option>
                           <option value='3' class="js-select-button">··Activities </option>
                           <option value='4' class="js-select-button"> ··Autos </option>
                           <option value='5' class="js-select-button"> ··Rooms </option>
                           <option value='6' class="js-select-button"> ··Others </option>
                        </select>
               ...
               <div class="col-9 float-left pl-2" style="background-color: #cc99cc;">
...
<br>
                     ...
                     <!-- EnD  New BiFilter -->
                     <div id="user-repositories-list" style="margin-top: -3px;">
                        <ul data-filterable-for="your-repos-filter" data-filterable-type="substring">
                                    ...
                                    <div class="card">
                                       <div class="card-horizontal">
                                          <div class="img-square-wrapper">
                                             <img class="" src="/img/Hilton.jpg" alt="Hotel" style="border: 2px solid black; border-radius: 5px;width: 200px;height: 100px;">
                                          </div>
                                          <div class="card-body">
                                    ...
                                    <div class="container-fluid" style="margin-top: 0px;margin-bottom: 0px;padding: 0px;margin: 0px;">
                                       <div class="row" style="margin-top: 0px;margin-bottom: 0px;padding: 0px;margin: 0px;">
                                          <div class="col-md-7" style="margin-top: 0px;margin-bottom: 0px;padding:-2px;margin: 0px;">
                                             <table style="width: 620px;"><tr ><td> <div class="img-square-wrapper" style="margin-top: 0px;padding: 0px;margin: 0px;">
                                                      ...
                                                      </div></td><td > <h6 class="card-title">${item.name}</h6>

                                                         <h6 class="card-title">${item.id}</h6>

                                                      <h6 class="card-title" style="color: darkred;">${item.precio} €</h6>
                                                      <h6 class="card-text">${item.description}</h6>
                                                      <button type="button" class="btn btn-outline-primary align-items-end clearfix" style="text-align: right;">        <a href="/delete/${item.id}">BORRAR</a></button>
                                                   </td></tr></table>
                           ...
                           </#list> <!-- here was a <hr> but need to  together the rows -->
                           </#if>
                           <#if act??>
                           <#list act as act>
